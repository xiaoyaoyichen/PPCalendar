package com.example.mycalendar.Schedule;
...
public class OneShotAlarm extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Toast.makeText(context,"时间到啦!", Toast.LENGTH_LONG).show();
    ...
    private void showNotice(Context context) {
        ...
        Notification notification=new NotificationCompat.Builder(context)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(),R.drawable.adaptiveproduct_calendarbasewithnumber_foreground_color_108))
                .setContentIntent(pi)
                .setAutoCancel(true)
